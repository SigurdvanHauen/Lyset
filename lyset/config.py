...
SCHEMA: list[dict] = [
    ...
    },
    {
        ...
        'fields': [
            ...
            {'key': 'PRICE_TILLAEG_ORE', 'label': 'Tillæg (øre/kWh)', 'type': 'number',
             'default': '10.00',
             'help': 'Your supplier\'s markup on the raw spot price, from your contract.'},
            {'key': 'PRICE_TRANSPORT_ORE', 'label': 'Transportbetaling (øre/kWh)', 'type': 'number',
             'default': '28.93',
             'help': 'Net-company transport tariff, from your bill. (If your DSO uses '
             'time-differentiated tariffs, enter the rate you want the planner to assume.)'},
            {'key': 'PRICE_ELAFGIFT_ORE', 'label': 'Elafgift (øre/kWh)', 'type': 'number',
             'default': '1.00',
             'help': 'Electricity tax, from your bill (excl. VAT). 1 øre ≈ the reduced elvarme rate.'},
            {'key': 'PRICE_VAT_PCT', 'label': 'Moms / VAT (%)', 'type': 'number',
             'default': '25',
             'help': 'VAT applied to spot + all fees to get the real import price. Set to 0 '
             'if the øre/kWh figures above are already VAT-inclusive.'},
